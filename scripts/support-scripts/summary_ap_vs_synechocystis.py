...
for tsv in sorted(Path(".").glob("abc_*_pairs.tsv")):
...
with open("blast_identity_summary.tsv", "w", newline="") as out:
...
print("\nWrote blast_identity_summary.tsv")